...
## News
''')
txt('Presented a [poster](https://www.bragitoff.com/2023/06/poster-icqc-2023-efficient-simulation-of-high-harmonic-generation-using-gaussian-basis-functions/) on *High Harmonic Generation using Gaussian Basis Functions* at the [International Conference of Quantum Chemistry 2023](https://icqc2023.org)','30 June 2023')
...
''')
txt4('Poster [🔗](https://www.bragitoff.com/2023/06/poster-icqc-2023-efficient-simulation-of-high-harmonic-generation-using-gaussian-basis-functions/)', 'International Confenerence of Quantum Chemistry 2023 ([link](https://icqc2023.org))', '25 June - 01 July 2023')
