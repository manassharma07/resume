...
txt4('RIPER - Tools', 'An online tools that allows to create input files for the RIPER module of TURBOMOLE from MaterialsProject or PubChem database', 'https://ripertools.turbomole.org')
